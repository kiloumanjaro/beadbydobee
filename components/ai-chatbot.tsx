  ...
  return (
    <>
      ...
      <Button
        ...
        size="icon"
        className={cn(
          "fixed bottom-6 right-6 z-50 p-5 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center gap-2",
      ...
      <div
        className={cn(
          "fixed bottom-6 right-6 z-50 w-96 h-[500px] bg-[#eeeeee] rounded-lg shadow-2xl flex flex-col transition-all duration-300 ease-in-out",
          isOpen
          ...
          {!hasUserSent && (
            ...
            >
              ...
              <span className="w-44 text-center text-xs text-[#727272] mb-5">
                I'm dobee, your personal borloloys asisstant
              </span>
            </div>
          )}
              ...
              {isApplyButtonHovered && (
                <span
                  className={`whitespace-nowrap transition-opacity duration-200 ${
                    isApplyButtonHovered ? "opacity-100 delay-150" : "opacity-0"
                  }`}
                >
                  Apply to Bracelet
                </span>
