...
export function ExpandableSocialCard() {
  ...
  return (
    <div
      className={cn(
        "bg-white rounded-full transition-all duration-300 ease-in-out cursor-pointer pl-8 pr-2 py-1.5",
    ...
    >
      <div>
        <span className="text-gray-800 text-xl font-medium transition-all duration-300">
          {isHovered ? "beadbydobee" : "beadbydobee"}
        </span>
      </div>

      <div
        className={cn(
          "bg-[#393738] text-white  rounded-full transition-all duration-300 h-10 flex items-center justify-center",
